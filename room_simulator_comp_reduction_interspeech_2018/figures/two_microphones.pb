# Test the effects of noise and reverberation case when we have two microphones.
#
# In this scenaraio, there are two microphones inside a room and there is a 
# target source and a noise source located in different positions of the room.
#
...
# There are two microphones placed inside a room.
# The distance between these two microphone is 2 cm apart along the y axis.
microphone_array {
  microphone_position {
    position_in_room {
