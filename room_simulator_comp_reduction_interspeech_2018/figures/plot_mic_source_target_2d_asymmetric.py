...
microphone_pos = np.array([2.5, 1.5])


x = np.linspace(2.5, 2.5, 10)
y = np.linspace(0.0, 1.5, 10)
...
#                         facecolor="gray", linewidth=2)
ax.add_patch(circle)
plt.text(microphone_pos[0] - 0.8, microphone_pos[1] - 0.3,
...
#         "d = 2.0 meters", ha="left", family='sans-serif', size=14)
...
#wedge = mpatches.Wedge(microphone_pos, 0.6, 30, 75, width=0.02, color='black')
#ax.add_artist(wedge)
...
ax.set_xticks([0.0, 2.0, 2.5, 4.0, 6.0, 8.9, 9.0])
ax.set_xticklabels(['0.0', '', '2.5 m', '', '', '', '8.9 m \n Width', ''])

ax.set_yticks([0.0, 1.5, 2.0, 4.0, 6.0, 6.8, 7.0])
ax.set_yticklabels(['', '1.5 m', '', '', 'Length \n 6.8 m',''], rotation='vertical')
